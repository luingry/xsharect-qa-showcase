...
| Silent client regression | Unexpected console/page errors fail the test | automatic fixture and manual two-context guard; reconnect permits only WebKit's exact deliberate-close message |
